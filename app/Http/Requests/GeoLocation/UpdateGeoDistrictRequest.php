...
class UpdateGeoDistrictRequest extends FormRequest
{
    /**
    ...
    public function rules() : array
    {
        ...
        return [
            ...
            'name_en'       => ['required', 'min:3', 'max:100', 'not_regex:/[0-9]/', Rule::unique('location_districts', 'name_en')->ignore($districtID),],
            'name_bn'       => ['nullable', 'min:3', 'max:100', 'not_regex:/[0-9]/', Rule::unique('location_districts', 'name_bn')->ignore($districtID),],
        ];
    }
