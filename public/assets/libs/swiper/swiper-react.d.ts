...
> &
  ...
  /**
   * Event will be fired when users touch Swiper. Receives `pointerdown` event as an arguments.
   */
  onTouchStart?: (swiper: SwiperClass, event: MouseEvent | TouchEvent | PointerEvent) => void;

  /**
   * Event will be fired when users touch and move finger over Swiper. Receives `pointermove` event as an arguments.
   */
  onTouchMove?: (swiper: SwiperClass, event: MouseEvent | TouchEvent | PointerEvent) => void;

  /**
   * Event will be fired when users touch and move finger over Swiper in direction opposite to direction parameter. Receives `pointermove` event as an arguments.
   */
  onTouchMoveOpposite?: (swiper: SwiperClass, event: MouseEvent | TouchEvent | PointerEvent) => void;

  /**
   * Event will be fired when users touch and move finger over Swiper and move it. Receives `pointermove` event as an arguments.
   */
  onSliderMove?: (swiper: SwiperClass, event: MouseEvent | TouchEvent | PointerEvent) => void;

  /**
   * Event will be fired when users release Swiper. Receives `pointerup` event as an arguments.
   */
  onTouchEnd?: (swiper: SwiperClass, event: MouseEvent | TouchEvent | PointerEvent) => void;

  /**
   * Event will be fired when users click/tap on Swiper. Receives `pointerup` event as an arguments.
   */
  ...
  /**
   * Event will be fired when users double tap on Swiper's container. Receives `pointerup` event as an arguments
   */
  ...
  /**
   * Event will be fired when users double click/tap on Swiper
   */
