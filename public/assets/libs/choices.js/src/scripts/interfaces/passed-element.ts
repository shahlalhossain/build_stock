...
export interface EventMap {
  /**
   * Triggered each time an item is added (programmatically or by the users).
   *
  ...
  /**
   * Triggered each time an item is removed (programmatically or by the users).
   *
   * **Input types affected:** text, select-one, select-multiple
   *
   * Arguments: id, value, label, groupValue
  ...
  /**
   * Triggered each time a choice is selected **by a users**, regardless if it changes the value of the input.
   *
  ...
  /**
   * Triggered each time an item is added/removed **by a users**.
   *
   * **Input types affected:** text, select-one, select-multiple
   *
   * Arguments: value
  ...
  /**
   * Triggered when a users types into an input to search choices. When a search is ended, a search event with an empty value with no resultCount is triggered.
   *
   * **Input types affected:** select-one, select-multiple
   *
