                            ...
                            <div class="card-body">
                                <div class="d-flex align-items-center mb-5">
                                    ...
                                    <div class="flex-shrink-0">
                                        <a href="javascript:void(0);" class="badge bg-light text-primary fs-12"><i class="ri-edit-box-line align-bottom me-1"></i> Update Profile</a>
                                    </div>
                                </div>
                        ...
                        <div class="card mt-xxl-n5">
                            <div class="card-header">
                                <ul class="nav nav-tabs-custom rounded card-header-tabs border-bottom-0" role="tablist">
                                    <li class="nav-item">
                                        <a class="nav-link active" data-bs-toggle="tab" href="#profileDetails" role="tab"><i class="fas fa-home"></i> Profile Details</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" data-bs-toggle="tab" href="#activityHistory" role="tab"><i class="far fa-envelope"></i> Activity History</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" data-bs-toggle="tab" href="#loginHistory" role="tab"><i class="far fa-envelope"></i> Login History</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" data-bs-toggle="tab" href="#changePassword" role="tab"><i class="far fa-user"></i> Change Password</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" data-bs-toggle="tab" href="#accountSettings" role="tab"><i class="far fa-envelope"></i> Account Settings</a>
                                    </li>
                                </ul>
                            </div>
                            <div class="card-body p-4">
                                <div class="tab-content">
                                    ...
                                    <div class="tab-pane" id="activityHistory" role="tabpanel">
                                        <table class="table table-sm table-nowrap table-hover table-bordered">
                                            <thead>
                                            <tr>
                                                <th scope="col">Id</th>
                                    ...
                                    <div class="tab-pane" id="accountSettings" role="tabpanel">
                                        <div class="mb-4 pb-2">
                                            ...
                                            <ul class="list-unstyled mb-0">
                                                <li class="d-flex">
                                                    <div class="flex-grow-1">
                                                        <label for="towFactorAuthentication" class="form-check-label fs-14">Two-Factor Authentication</label>
                                                    </div>
                                                    <div class="flex-shrink-0">
                                                        <div class="form-check form-switch">
                                                            <input class="form-check-input" type="checkbox" role="switch" id="towFactorAuthentication" checked />
                                                        </div>
                                                    </div>
                                                </li>
                                                <li class="d-flex mt-2">
                                                    <div class="flex-grow-1">
                                                        <label class="form-check-label fs-14" for="secondaryVerification">Secondary Verification</label>
                                                    </div>
                                                    <div class="flex-shrink-0">
                                                        <div class="form-check form-switch">
                                                            <input class="form-check-input" type="checkbox" role="switch" id="secondaryVerification" checked />
                                                        </div>
                                                    </div>
                                                </li>
                                                <li class="d-flex mt-2">
                                                    <div class="flex-grow-1">
                                                        <label class="form-check-label fs-14" for="backupCode">Backup Codes</label>
                                                    </div>
                                                    <div class="flex-shrink-0">
                                                        <div class="form-check form-switch">
                                                            <input class="form-check-input" type="checkbox" role="switch" id="backupCode" />
                                                        </div>
                                                    </div>
                                                </li>
                                            </ul>
                                        ...
                                        <div class="mb-3">
                                            <div class="mt-4 mb-3 border-bottom pb-2">
                                                <div class="float-end"></div>
                                                <h5 class="card-title">Application Notifications</h5>
                                            </div>
                                            <ul class="list-unstyled mb-0">
                                                <li class="d-flex">
                                                    <div class="flex-grow-1">
                                        ...
                                        <div>
                                            ...
                                            <div class="hstack gap-2 mt-3">
                                                <a href="javascript:void(0);" class="btn btn-soft-danger">Close & Disable Account</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
