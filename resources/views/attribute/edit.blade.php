                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header align-items-center d-flex">
                            <h4 class="card-title mb-0 flex-grow-1">{{ __('Attribute Edit & Update') }}</h4>
                            <div class="flex-shrink-0">
                                <a href="{{ route('attribute.edit', $attribute->id) }}" class="btn btn-sm btn-warning">
                                    <i class="ri-refresh-line"></i><span class="d-none d-sm-inline"> {{ __('Reload') }}</span>
                                </a>
                                <a href="{{ route('attribute.index') }}" class="btn btn-sm btn-primary">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12 col-md-7 order-1 attribute-col-left">
                                        ...
                                        <div class="row mb-2">
                                            ...
                                            <div class="col-12 col-md-8">
                                                <input type="text" class="form-control @error('description') is-invalid @enderror" id="description" name="description" value="{{ old('description', $attribute->description) }}">
...
@push('scripts')
    <script>
        $(document).ready(function () {
            ...
            // Seed with one starter row if none were pre-filled.
            if ($('#values-rows .repeater-row').length === 0) {
                addRow('values');
            }
        });
    </script>
