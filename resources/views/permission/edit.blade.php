                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header align-items-center d-flex">
                            <h4 class="card-title mb-0 flex-grow-1">{{ __('Permission Edit & Update') }}</h4>
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <select class="form-select @error('parent_id') is-invalid @enderror" id="parent" name="parent_id">
                                                    ...
                                                    @foreach($parentPermissions as $parentPermission)
                                                        <option value="{{ $parentPermission->id }}"{{ old('parent_id', $permission->parent_id) == $parentPermission->id ? 'selected' : '' }}> {{ $parentPermission->description }}</option>
                                                    @endforeach
                                                </select>
