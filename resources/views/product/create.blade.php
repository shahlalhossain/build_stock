                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12 col-md-7">
                                        ...
                                        <div class="row mb-2">
                                            ...
                                            <div class="col-12 col-md-8">
                                                <input type="text" class="form-control @error('code') is-invalid @enderror" id="code" name="code" value="{{ old('code') }}" required placeholder="">
                                        ...
                                        <div class="row mb-2">
                                            ...
                                            <div class="col-12 col-md-8 pt-2">
                                                <div class="form-check form-switch">
                                                    ...
                                                    <input type="checkbox" class="form-check-input" id="has_variants" name="has_variants" value="1" @checked(old('has_variants'))>
                                                </div>
