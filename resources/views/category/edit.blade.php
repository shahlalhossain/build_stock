                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header align-items-center d-flex">
                            <h4 class="card-title mb-0 flex-grow-1">{{ __('Category Edit & Update') }}</h4>
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12 col-md-7">
                                        ...
                                        <div class="row mb-2">
                                            <label for="name" class="col-12 col-md-4 col-form-label text-md-end text-start form-mandatory">{{ __('Category Name') }}</label>
                                        ...
                                        <div class="row mb-2">
                                            ...
                                            <div class="col-12 col-md-8">
                                                <input type="text" class="form-control @error('priority_order') is-invalid @enderror" id="priority_order" name="priority_order" value="{{ old('priority_order', $category->priority_order) }}" required>
                            ...
                            <div class="card-footer">
                                <div class="row">
                                    <div class="col-6 text-start">
                                        <a href="{{ route('category.index') }}" class="btn btn-sm btn-danger">{{ __('Cancel') }}</a>
