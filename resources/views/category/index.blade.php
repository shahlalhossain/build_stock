                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header align-items-center d-flex">
                            <h4 class="card-title mb-0 flex-grow-1">{{ __('Manage Categories') }}</h4>
                            <div class="flex-shrink-0">
                                ...
                                <a href="{{ route('category.trash') }}" class="btn btn-sm btn-dark"><i class="ri-delete-bin-2-line"></i><span class="d-none d-sm-inline"> {{ __('Trash Box') }}</span></a>
                            </div>
                        </div>
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            ...
                            success: function (response) {
                                ...
                                // Reload/Redirect to Category List Page
                            ...
                            error: function (xhr, status, error) {
                                ...
                                sessionStorage.setItem( 'categoryToastMessage', message ); sessionStorage.setItem( 'categoryToastType', 'failed' );
                                // Reload/Redirect to Category List Page
                                window.location.href = '/category';
                            }
                        });
