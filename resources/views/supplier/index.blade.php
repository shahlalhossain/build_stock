                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header align-items-center d-flex">
                            <h4 class="card-title mb-0 flex-grow-1">{{ __('Manage Suppliers') }}</h4>
                            <div class="flex-shrink-0">
                                ...
                                <a href="{{ route('supplier.trash') }}" class="btn btn-sm btn-dark"><i class="ri-delete-bin-2-line"></i><span class="d-none d-sm-inline"> {{ __('Trash Box') }}</span></a>
                            </div>
                        </div>
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            ...
                            success: function (response) {
                                ...
                                // Reload/Redirect to Supplier List Page
                            ...
                            error: function (xhr, status, error) {
                                ...
                                sessionStorage.setItem( 'supplierToastMessage', message ); sessionStorage.setItem( 'supplierToastType', 'failed' );
                                // Reload/Redirect to Supplier List Page
                                window.location.href = '/supplier';
                            }
                        });
