                                ...
                                <div class="row">
                                        ...
                                        <div class="row mb-2">
                                            ...
                                            <div class="col-12 col-md-8">
                                                ...
                                                <select id="supplier_type_id" name="supplier_type_id" class="form-select @error('supplier_type_id') is-invalid @enderror" required>
                                                    ...
                                                    <option value="{{ $supplier->supplier_type_id }}" selected>{{ $supplier->supplier_type_id }}</option>
                                                </select>
                                    ...
                                    <div class="col-12 col-md-6">
                                        ...
                                        <div class="row mb-2">
                                            ...
                                            <div class="col-12 col-md-8">
                                                <textarea class="form-control @error('remarks') is-invalid @enderror" id="remarks" name="remarks" rows="1">{{ old('remarks', $supplier->remarks) }}</textarea>
...
@push('scripts')
    <script>
        $(document).ready(function () {
            ...
            |--------------------------------------------------------------------------
            | Same mechanics as the Create form's repeater, but each group is seeded
            | from the Supplier's existing rows (via addRow's optional `data` argument)
            | instead of one empty starter row.
            */
            const rowCounters = {
                contacts: 0,
                addresses: 0,
            ...
            if (existingAddresses.length) {
                existingAddresses.forEach(row => addRow('addresses', row));
            } else {
                addRow('addresses');
            }

            existingPaymentAccounts.forEach(row => addRow('payment_accounts', row));
