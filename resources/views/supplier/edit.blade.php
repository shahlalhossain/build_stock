                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header align-items-center d-flex">
                            <h4 class="card-title mb-0 flex-grow-1">{{ __('Supplier Edit & Update') }}</h4>
                        ...
                        <form action="{{ route('supplier.update', $supplier->id) }}" method="POST" enctype="multipart/form-data" id="supplierForm">
                            @csrf
                            @method('PATCH')
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-12 col-md-6">
                                        <div class="row mb-2">
                                            <label for="code" class="col-12 col-md-4 col-form-label text-md-end text-start">{{ __('Supplier Code') }}</label>
                                            <div class="col-12 col-md-8">
                                                <input type="text" class="form-control" id="code" value="{{ $supplier->code }}" readonly disabled>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-12 col-md-8">
                                                <select id="supplier_type_id" name="supplier_type_id" class="form-select @error('supplier_type_id') is-invalid @enderror" required>
                                                    ...
                                                    @foreach($supplierTypes as $supplierType)
                                                        <option value="{{ $supplierType->id }}" @selected(old('supplier_type_id', $supplier->supplier_type_id) == $supplierType->id)>{{ $supplierType->name }}</option>
                                                    @endforeach
                                                </select>
                                        ...
                                        <div class="row mb-2">
                                            ...
                                            <div class="col-12 col-md-8">
                                                <input type="text" class="form-control @error('tin_number') is-invalid @enderror" id="tin_number" name="tin_number" value="{{ old('tin_number', $supplier->tin_number) }}">
                                        ...
                                        <div class="row mb-2">
                                            ...
                                            <div class="col-12 col-md-8">
                                                <input type="text" class="form-control @error('bin_number') is-invalid @enderror" id="bin_number" name="bin_number" value="{{ old('bin_number', $supplier->bin_number) }}">
                                        ...
                                        <div class="row mb-2">
                                            ...
                                            <div class="col-12 col-md-8">
                                                <input type="text" class="form-control @error('credit_limit') is-invalid @enderror" id="credit_limit" name="credit_limit" value="{{ old('credit_limit', $supplier->credit_limit) }}">
                                        ...
                                        <div class="row mb-2">
                                            ...
                                            <div class="col-12 col-md-8">
                                                <input type="text" class="form-control @error('minimum_order_quantity') is-invalid @enderror" id="minimum_order_quantity" name="minimum_order_quantity" value="{{ old('minimum_order_quantity', $supplier->minimum_order_quantity) }}">
                                    ...
                                    <div class="col-12 col-md-6">
                                        <div class="row mb-2">
                                            ...
                                            <div class="col-12 col-md-8">
                                                <input type="text" class="form-control @error('minimum_order_amount') is-invalid @enderror" id="minimum_order_amount" name="minimum_order_amount" value="{{ old('minimum_order_amount', $supplier->minimum_order_amount) }}">
                                        ...
                                        <div class="row mb-2">
                                            ...
                                            <div class="col-12 col-md-8">
                                                <div class="input-group">
                                                    <input type="text" class="form-control @error('payment_terms_days') is-invalid @enderror" id="payment_terms_days" name="payment_terms_days" value="{{ old('payment_terms_days', $supplier->payment_terms_days) }}">
                                        ...
                                        <div class="row mb-2">
                                            ...
                                            <div class="col-12 col-md-8">
                                                <div class="input-group">
                                                    <input type="text" class="form-control @error('lead_time_days') is-invalid @enderror" id="lead_time_days" name="lead_time_days" value="{{ old('lead_time_days', $supplier->lead_time_days) }}">
                                        ...
                                        <div class="row mb-2">
                                            ...
                                            <div class="col-12 col-md-8">
                                                <textarea class="form-control @error('description') is-invalid @enderror" id="description" name="description" rows="2">{{ old('description', $supplier->description) }}</textarea>
                                        ...
                                        <div class="row mb-2">
                                            ...
                                            <div class="col-12 col-md-8">
                                                <textarea class="form-control @error('remarks') is-invalid @enderror" id="remarks" name="remarks" rows="2">{{ old('remarks', $supplier->remarks) }}</textarea>
                                ...
                                <template id="payment_accounts-row-template">
                                    <div class="row mb-2 align-items-start repeater-row" data-group="payment_accounts">
                                        ...
                                        <div class="col-12 col-sm-12 col-md-2 pt-2">
                                            <input type="text" class="form-control branch-routing-number" disabled placeholder="{{ __('Routing Number') }}">
                                        </div>
                                        <div class="col-12 col-sm-12 col-md-1 text-end text-md-start" style="padding-top: 13px;">
                                            <button type="button" class="btn btn-sm btn-outline-danger remove-row"><i class="ri-close-line"></i></button>
                                        </div>
...
@push('scripts')
    <script>
        $(document).ready(function () {
            ...
            |--------------------------------------------------------------------------
            | Same mechanics as the Create form's repeater. Each group is seeded
            | from the Supplier's existing rows (via addRow's optional `data`
            | argument) instead of one empty starter row.
            */
            const rowCounters = {
                contacts: 0,
                addresses: 0,
            ...
            function addRow(group, data) {
                ...
                if (data) {
                    $.each(data, function (field, value) {
                        // is_primary is a radio (fixed value="1"); setting .val() on it
                        // would overwrite that fixed value with the boolean itself
                        // (e.g. "true"), which then fails the boolean validation rule.
                        // It's handled separately below via .prop('checked', ...).
                        if (field === 'is_primary') {
                            return;
                        }
                        $row.find('[name="' + group + '[' + index + '][' + field + ']"]').val(value);
                    });
                    if (data.is_primary) {
                        $row.find('.primary-radio').prop('checked', true);
                    }
                }
            ...
            const existingAddresses = @json($supplier->addresses);
            const existingPaymentAccounts = @json($supplier->paymentAccounts);
            const existingMfsAccounts = @json($supplier->mfsAccounts);
            ...
            */
            ...
            | loadDistricts/loadThanas accept an optional selectedId so the
            | pre-filled row can restore its saved District/Thana once the
            | AJAX-fetched options arrive.
            */
            function loadDistricts(row, divisionId, selectedDistrictId, callback) {
            ...
            function loadThanas(row, districtId, selectedThanaId) {
            ...
            $(document).on('change', '.address-division', function () {
                loadDistricts($(this).closest('.repeater-row'), $(this).val(), null);
            });

            $(document).on('change', '.address-district', function () {
                loadThanas($(this).closest('.repeater-row'), $(this).val(), null);
            });
            ...
            */
            function loadBranches(row, bankId, selectedBranchName, callback) {
                ...
                $.get('{{ route('getBranchesByBank') }}', { bank_id: bankId }, function (branches) {
                    branches.forEach(function (branch) {
                        const selected = selectedBranchName && branch.branch_name === selectedBranchName ? 'selected' : '';
                        $branch.append('<option value="' + branch.branch_name + '" data-routing-no="' + (branch.routing_no ?? '') + '" ' + selected + '>' + branch.branch_name + '</option>');

                        if (selected) {
                            $routing.val(branch.routing_no ?? '');
                        }
                    });
                    if (typeof callback === 'function') {
                        callback();
            ...
            */
            if (existingContacts.length) {
                existingContacts.forEach(row => addRow('contacts', row));
            } else {
                addRow('contacts');
            }

            if (existingAddresses.length) {
                existingAddresses.forEach(function (row) {
                    const $row = addRow('addresses', {
                        address: row.address,
                        address_type: row.address_type_id,
                    });

                    $row.find('.address-division').val(row.division_id ?? '');

                    if (row.division_id) {
                        loadDistricts($row, row.division_id, row.district_id, function () {
                            if (row.district_id) {
                                loadThanas($row, row.district_id, row.thana_id);
                            }
                        });
                    }
                });
            ...
            existingPaymentAccounts.forEach(function (row) {
                const $row = addRow('payment_accounts', {
                    account_name: row.account_name,
                    account_number: row.account_number,
                    is_primary: row.is_primary,
                });

                const $bankOption = $row.find('.payment-bank option').filter(function () {
                    return $(this).val() === row.bank_name;
                });

                if ($bankOption.length) {
                    $row.find('.payment-bank').val(row.bank_name);
                    loadBranches($row, $bankOption.data('bank-id'), row.branch_name);
                }
            });

            existingMfsAccounts.forEach(row => addRow('mfs_accounts', row));
        });
    </script>
@endpush
