                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12 col-md-6">
                                        ...
                                        <div class="row mb-2">
                                            ...
                                            <div class="col-12 col-md-8">
                                                <input type="text" class="form-control @error('priority_order') is-invalid @enderror" id="priority_order" name="priority_order" value="{{ old('priority_order') }}">
                                        ...
                                        <div class="row mb-2">
                                            ...
                                            <div class="col-12 col-md-8">
                                                <textarea class="form-control @error('site_address') is-invalid @enderror" id="site_address" name="site_address" rows="2">{{ old('site_address') }}</textarea>
