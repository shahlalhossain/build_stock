                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header align-items-center d-flex">
                            <h4 class="card-title mb-0 flex-grow-1">{{ __('Manage Projects') }}</h4>
                            <div class="flex-shrink-0">
                                ...
                                <a href="{{ route('project.trash') }}" class="btn btn-sm btn-dark"><i class="ri-delete-bin-2-line"></i><span class="d-none d-sm-inline"> {{ __('Trash Box') }}</span></a>
                            </div>
                        </div>
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            ...
                            success: function (response) {
                                ...
                                // Reload/Redirect to Project List Page
                            ...
                            error: function (xhr, status, error) {
                                ...
                                sessionStorage.setItem( 'projectToastMessage', message ); sessionStorage.setItem( 'projectToastType', 'failed' );
                                // Reload/Redirect to Project List Page
                                window.location.href = '/project';
                            }
                        });
