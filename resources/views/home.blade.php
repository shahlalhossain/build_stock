            ...
            <div class="row justify-content-center">
                <div class="col-lg-8 col-sm-10">
                    <div class="text-center mt-lg-5 pt-5">
                        <h1 class="display-6 fw-semibold mb-3 lh-base">The better way to manage your website with <span class="text-success">Microzen </span></h1>
                        <p class="lead text-muted lh-base">Microzen is a fully responsive, multipurpose and premium Bootstrap 5 Admin & Dashboard Template built in multiple frameworks.</p>
    ...
    <section class="py-5 bg-primary position-relative">
        ...
        <div class="container">
            <div class="row align-items-center gy-4">
                <div class="col-sm">
                    <div>
                        <h4 class="text-white mb-0 fw-semibold">Build Your Microfinance Web & Mobile Application Microzen</h4>
                    </div>
                </div>
                <!-- end col -->
                <div class="col-sm-auto">
                    <div>
                        <a href="https://1.envato.market/velzon-admin" target="_blank" class="btn bg-gradient btn-danger"><i class="ri-shopping-cart-2-line align-middle me-1"></i> Register Now</a>
                    </div>
                </div>
                <!-- end col -->
            </div>
    ...
    <section class="py-5 bg-primary position-relative">
        ...
        <div class="container">
            <div class="row align-items-center gy-4">
                <div class="col-sm">
                    <div>
                        <h4 class="text-white mb-0 fw-semibold">Build Your Web & Mobile App with Microzen</h4>
                    </div>
                </div>
                <!-- end col -->
                <div class="col-sm-auto">
...
{{--                            <p>Premium Multipurpose Admin & Dashboard Template</p>--}}
                            <p class="ff-secondary">You can build any type of Web Application like CMS, CRM, Admin Panels, Project Management, HRM, MIS, FIS, Reporting Panel, Dashboard Panel etc using Microzen.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-sm-6">
                    ...
                    <div>
                        <p class="copy-rights mb-0">
                            <script> document.write(new Date().getFullYear()) </script> © Microzen
                        </p>
                    </div>
                </div>
                <div class="col-sm-6">
