                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header align-items-center d-flex">
                            <h4 class="card-title mb-0 flex-grow-1">{{ __('Manage Districts') }}</h4>
                        ...
                        <div class="card-body">
                            ...
                            <table id="districts-table" class="table table-hover table-bordered dt-responsive nowrap table-striped align-middle" style="width:100%">
                    ...
                    $.ajax({
                        ...
                        success: function (response) {
                            ...
                            Swal.fire('Deleted', 'The Record has been Deleted.', 'success')
                                .then(() => { window.location.href = '/district'; });  // Redirect to the District List
                        },
