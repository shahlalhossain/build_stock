                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header align-items-center d-flex">
                            <h4 class="card-title mb-0 flex-grow-1">{{ __('Warehouse Edit & Update') }}</h4>
                            <div class="flex-shrink-0">
                                ...
                                <a href="{{ route('warehouse.index') }}" class="btn btn-sm btn-primary">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-12 col-md-7">
                                        <div class="row mb-2">
                                            ...
                                            <div class="col-12 col-md-8">
                                                <select id="project_id" name="project_id" class="form-select @error('project_id') is-invalid @enderror">
                                                    <option value="" @selected(old('project_id', $warehouse->project_id) === null)>{{ __('Head Office') }}</option>
                                                    @foreach($projects as $proj)
                                                        <option value="{{ $proj->id }}" @selected(old('project_id', $warehouse->project_id) == $proj->id)>{{ ucwords($proj->name) }}</option>
                                                    @endforeach
                                                </select>
                                        ...
                                        <div class="row mb-2">
                                            <label for="name" class="col-12 col-md-4 col-form-label text-md-end text-start form-mandatory">{{ __('Warehouse Name') }}</label>
                                            <div class="col-12 col-md-8">
                                        ...
                                        <div class="row mb-2">
                                            <label for="code" class="col-12 col-md-4 col-form-label text-md-end text-start form-mandatory">{{ __('Warehouse Code') }}</label>
                                            <div class="col-12 col-md-8">
                            ...
                            <div class="card-footer">
                                <div class="row">
                                    <div class="col-6 text-start">
                                        <a href="{{ route('warehouse.index') }}" class="btn btn-sm btn-danger">{{ __('Cancel') }}</a>
