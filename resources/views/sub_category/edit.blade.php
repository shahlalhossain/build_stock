                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header align-items-center d-flex">
                            <h4 class="card-title mb-0 flex-grow-1">{{ __('Sub-Category Edit & Update') }}</h4>
                            <div class="flex-shrink-0">
                                <a href="{{ route('sub-category.edit', $subCategory->id) }}" class="btn btn-sm btn-warning">
                                    <i class="ri-refresh-line"></i><span class="d-none d-sm-inline"> {{ __('Reload') }}</span>
                                </a>
                                <a href="{{ route('sub-category.index') }}" class="btn btn-sm btn-primary">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12 col-md-7">
                                            ...
                                            <div class="col-12 col-md-8">
                                                <select id="category_id" name="category_id" class="form-select @error('category_id') is-invalid @enderror" required>
                                                    ...
                                                    @foreach($categories as $cat)
                                                        <option value="{{ $cat->id }}" @selected(old('category_id', $subCategory->category_id) == $cat->id)>{{ ucwords($cat->name) }}</option>
                                                    @endforeach
                                                </select>
                                        ...
                                        <div class="row mb-2">
                                            <label for="name" class="col-12 col-md-4 col-form-label text-md-end text-start form-mandatory">{{ __('Sub-Category Name') }}</label>
                                            <div class="col-12 col-md-8">
                                        ...
                                        <div class="row mb-2">
                                            ...
                                            <div class="col-12 col-md-8">
                                                <input type="text" class="form-control @error('priority_order') is-invalid @enderror" id="priority_order" name="priority_order" value="{{ old('priority_order', $subCategory->priority_order) }}" required>
                                        ...
                                        <div class="row mb-2">
                                            ...
                                            <div class="col-12 col-md-8">
                                                <input type="text" class="form-control @error('description') is-invalid @enderror" id="description" name="description" value="{{ old('description', $subCategory->description) }}">
                            ...
                            <div class="card-footer">
                                <div class="row">
                                    <div class="col-6 text-start">
                                        <a href="{{ route('sub-category.index') }}" class="btn btn-sm btn-danger">{{ __('Cancel') }}</a>
